...
METHOD_LABELS = {
    "xqdrant_esm2": "XQdrant",
    "esm2_cosine": "ESM2 cosine",
    "blastp": "BLASTp",
    "foldseek": "Foldseek",
    "tmalign_rerank_foldseek": "TM-align†",
}

METHOD_COLORS = {
    "xqdrant_esm2": PALETTE["xqdrant"],
    "esm2_cosine": PALETTE["esm2"],
    "blastp": PALETTE["blast"],
    "foldseek": PALETTE["foldseek"],
    "tmalign_rerank_foldseek": PALETTE["tmalign"],
}
...
def main() -> int:
    ...
    for i, (vals, lab, off) in enumerate(
        [(r1, "R@1", -w), (r5, "R@5", 0), (r10, "R@10", w)]
    ):
