...
from _common import BIO_ROOT, PALETTE, RESULTS, read_tsv, save, setup_style  # noqa: E402

METHODS = [
    ("xq_profile_spearman", "XQ profile Spearman", PALETTE["xqdrant"]),
    ("uniform_dims_spearman", "Uniform dims (control)", PALETTE["foldseek"]),
    ("random_dims_spearman", "Random dims (null)", PALETTE["diff_fold"]),
]

METHOD_AUROC = {
    "xq_profile_spearman": 0.628,
    "uniform_dims_spearman": 0.599,
    "random_dims_spearman": 0.528,
}
...
def main() -> int:
    ...
    # Prefer AUROC from summary if available
