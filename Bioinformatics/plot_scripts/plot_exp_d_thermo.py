...
FEATURE_LABELS = {'frac_charged_exposed': 'Δ charged exposed', 'mean_loop_length': 'Δ loop length', 'packing_density': 'Δ packing (SASA)', 'ion_pair_density': 'Δ ion-pair density'}

def scatter_attribution_vs_delta(metrics: dict) -> None:
    pairs = metrics['pairs']
    fig, axes = plt.subplots(2, 2, figsize=(8, 7))
    axes = axes.ravel()
    colors_by_source = {'literature': PALETTE['literature'], 'structure_map': PALETTE['structure_map'], 'auto_fold': PALETTE['auto_fold']}
