...
from common_bio import load_yaml, resolve_path, write_json
from exp_a_retrieval import finalize_metrics, load_jsonl_records, write_summary_tsv
...
def main() -> int:
    ...
    metrics = finalize_metrics(records, ks=ks, coll=coll, smoke=smoke, dims_top=dims_top, elapsed_s=elapsed, n_boot=args.bootstrap, boot_seed=int(exp_cfg.get('bootstrap_seed', 42)))
