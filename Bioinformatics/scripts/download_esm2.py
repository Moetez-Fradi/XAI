...
from common_bio import BIO_ROOT, download_cfg, ensure_dir, load_yaml, write_json  # noqa: E402
...
def main() -> int:
    ...
    try:
        ...
        print(
            "huggingface_hub not installed. Run ./setup_env.sh first.",
            file=sys.stderr,
        )
        return 1
    ...
    write_json(
        local_dir / "download_manifest.json",
        {
            "repo_id": repo_id,
            "local_dir": path,
            "allow_patterns": allow,
